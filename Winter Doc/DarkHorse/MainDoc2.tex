...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\include{Development}   %Results of benchmarking, need-finding, CFP, CEP etc.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{DarkHorse}  

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Funky}   %Include survey at the end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Functional}   %Include interview and research at the beginning 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Description}  %This section is just your proposal or "Vision" for Fall.
