...
\caption{Watch mechanism}% - http://www.menshealth.co.uk/living/gear/watch-movements-explained}
...
\begin{figure}[h]
  \centering
     %\includegraphics[width=7cm]{images/system_diagram.jpg}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=8cm]{images/tracking.png}
