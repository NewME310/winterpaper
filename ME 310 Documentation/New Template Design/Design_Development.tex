...
\emph{Integrated Toilet Seat} It consists in a module that would be installed bellow each seat giving even more autonomy to the user once one did not need to call a flight attendant to go to 
...
\emph{Hardcase for Wheelchairs} The universal hardcase for wheelchairs was conceived to reduce the number of wheelchairs damaged in flights, which represents a huge cause of anxiety for users. As a consequence, this would improve the disabled passengers’ experience and reduce the costs with compensations provided by airlines. Nevertheless, the group did not have enough knowledge concerning the wheelchair storage procedure, making this solution not viable for the Dark Horse. \\
...
\caption{Current toilet on the airplane}% - http://articles.latimes.com/2012/dec/18/news/la-trb-potty-airline-seats-20121217}
...
\caption{Pivoting door} % - http://www.vitrinenews.com.br/vitrine/index.php?option=com_content\&view=category\&layout=blog\&id=33\&Itemid=45\&limitstart=40}
...
\caption{Dual wheelchair foot support} % - http://www.dietz-reha.com/dietz_de/eclipse}
\label{fig:dual_wheelchair}
\end{figure}

\emph{Office Skate} This is a product used to give support for the employee’s feet giving at the same time capacity to move. That could be used on our product to allow the sliding of the passenger’s feet.

\begin{figure}[h]
\centering
\includegraphics[width=7cm]{brazil_images/image024.jpg}
\caption{Office skate} % - http://www.grabc4d.org/viewthread.php?tid=10156}
...
After that we cut the fiberboard, built the prototype and tested it with some people from outside the design group, but that did not had mobility issues as shows Figure 27: Woodwork - Dark Horse, Figure 28: Testing the resistance of the turning seat and Figure 29: Testing with people outside the group. Unfortunately, because our prototype was huge and heavy, it couldn’t be easy transported and because our campus has not many wheelchair users, we were not able to test it with our actual target users.

\begin{figure}[h]
\centering
\includegraphics[width=7cm]{brazil_images/image029.jpg}
\caption{Woodwork dark horse}
\label{fig:woodwork}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=7cm]{brazil_images/image030.jpg}
\caption{Testing the resistance of the turning seat}
\label{fig:test_resistance}
\end{figure}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{system_diagram.jpg}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{ArmrestsControls1.jpg}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{ArmrestsControls2.jpg}
   \caption{Example of current controls on the armrest in a Business Class seat. \cite{armrest_control2}}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{HingedArmrest.jpg}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{TVScreenwithRemote.jpg}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{TouchscreenTV.jpg}
   \caption{Touchscreen TV on an airplane. \cite{touchscreen} }
  \label{fig:TouchscreenTV.jpg}
\end{figure}

\textbf{Version 2: Controlling the Environment with a New Armrest and Controls}\\
...
\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{FrontArmrests.jpg}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{MassagerArmrests.jpg}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{AssistiveArmrests.jpg}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{ControlArchitecture.jpg}
...
\textbf{Buttons on armrest}

\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{FoamArmrest.jpg}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{MATLABGUI.jpg}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=7cm]{TrackbalI.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[width=7cm]{brazil_images/image046.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[width=7cm]{brazil_images/image051.jpg}
